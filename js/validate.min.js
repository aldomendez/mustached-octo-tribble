...
(function(q,r,m){var s={
	required:"El campo '%s' es requerido",
	matches:"El campo '%s' no coincide con el campo '%s' ",
	"default":"El campo '%s' tiene el valor predeterminado, cambialo",
	valid_email:"El campo '%s' Debe de tener una direccion de correo electronico valido.",
	valid_emails:"El campo '%s' debe de tener todos los correos validos .",
	min_length:"The %s field must be at least %s characters in length.",
	max_length:"El campo '%s' no debe de exceder: %s caracteres.",
	...
	numeric:"El campo '%s' debe de contener solamente numeros.",
